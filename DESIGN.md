...
- 2026-09-01: Made the relationship map permanently visible and separated market-window controls from graph-window controls. Reason: a period tag must sit beside the content it changes; customer offerings and partnerships are baseline relationships, while company×change-theme edges can be filtered by week, month, quarter, or year.
