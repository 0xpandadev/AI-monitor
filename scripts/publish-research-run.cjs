...
const dir=path.join(root,'data','runs',runId);const update=JSON.parse(fs.readFileSync(path.join(dir,'weekly-update.json'),'utf8'));const manifest=JSON.parse(fs.readFileSync(path.join(dir,'manifest.json'),'utf8'));
